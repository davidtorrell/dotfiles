...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
map <leader>e :e! ~/.ciber_dotfiles/vim_runtime/my_configs.vim<cr>
autocmd! bufwritepost ~/.ciber_dotfiles/vim_runtime/my_configs.vim source ~/.ciber_dotfiles/vim_runtime/my_configs.vim
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
try
    set undodir=~/.ciber_dotfiles/vim_runtime/temp_dirs/undodir
    set undofile
catch
endtry
